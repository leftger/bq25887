#![doc = "Build script that generates the BQ25887 register API from the YAML manifest."]
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let generated = device_driver_generation::transform_yaml(&manifest, "Bq25887");
    ...
    let dest = out_dir.join("bq25887_device.rs");
